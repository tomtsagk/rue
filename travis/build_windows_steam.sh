...
# install steam
wget ${STEAMWORKS_DOWNLOAD_LINK} --quiet
...
mkdir ../cengine
cp -r avdl/engines/cengine/src/*.c avdl/engines/cengine/include/*.h avdl/engines/cengine/src/*.cpp ../cengine
...
cmake ../ . -DCMAKE_INSTALL_PREFIX="C:/Program Files/rue_install" -DAVDL_STEAM=1
cmake --build . --config Release
cmake --install .
